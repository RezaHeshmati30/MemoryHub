        ...
        if (!hasToken) {
            return (
                ...
                <>
                    ...
                    <li className="block ">
                        <button onClick={onClickLoginHandler} className=" w-[45px] h-[18px] auth-button text-black font-dm-sans text-[1.2em] font-bold uppercase">Login</button>
                    </li>
                    <li className="block">
                        <button onClick={onClickSignUpHandler} className=" w-[4.7em] h-[1.2em] auth-button inline-flex items-center gap-2 px-9 py-4 justify-center bg-black text-white text-[1.2em] rounded-full">SignUp</button>
                    </li>
                </>
            );
        } else {
            return (
                <>
                    <li className="block">
                        <Link to={`/user/${userId}`} className="auth-button text-black font-dm-sans text-[1.2em] uppercase ">MY ACCOUNT</Link>
                    </li>
                    <li className="block">
                    <button
