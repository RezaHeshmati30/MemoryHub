  ...
  return (
    <div className='max-container mx-auto '>
      <div
        ...
        } fixed top-[15%] right-0 left-0 z-50 mx-auto flex-col justify-center items-center rounded-lg border border-gray-300 bg-white w-[482px] h-[606px] `}
      >
        {isCreateCardsClicked && (
          <h2 className=' text-[#F70000] font-sans text-[1.4em] mb-5 '>
            Please log in or sign up first to have the possibility to create
            your own set.{" "}
          </h2>
        )}
        <div className='w-full flex justify-between items-center px-6  '>
          <h2 className='text-black font-normal font-sans text-[3em]'>
            Log In
          </h2>
