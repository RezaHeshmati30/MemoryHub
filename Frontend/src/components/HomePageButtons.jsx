...
function HomePageButtons() {
  ...
  return (
    ...
    <section className='pt-12 pb-4 mt-20 flex justify-between '>
      <button onClick={() => navigate("/modules")} className='bg-[#000] text-white rounded-[36px] flex justify-center items-center flex-shrink-0 w-48 h-16 text-white font-dm-sans font-bold text-base mr-10'>STUDY SETS</button>
