      ...
      <div className="flex gap-4 mt-6">
        ...
        <div className="border-[1px] w-full border-[#BCC0C1] rounded-md p-4 bg-white">
          ...
          <div className="mt-4 ">
               ...
               <button className={isPasswordChangeOpen ? 'hidden' :"bg-black text-white px-8 py-3 dm-sans-bold text-[1.2em] rounded-md mt-4"}  onClick={handleOpenPasswordChange}>Change Passwort</button>
