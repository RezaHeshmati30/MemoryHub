  ...
  return (
    <div className="flex flex-col justify-center">
      <div className='flex justify-center items-center'>
        <img src={user?.photo} alt="profile picture" className='m-4 w-[60px] h-[60px] rounded-full border-2 border-white shadow-lg shadow-black-500/50' />
        <p className="text-[3em] dm-sans-regular">{user?.firstName} {user?.lastName}</p>
        <p></p>
      </div>
      <section className="w-[80%] m-auto" aria-multiselectable="false">
        ...
        <div className="flex justify-center items-center">
          <div
            className={` w-[60%] border-solid border-2 border-gray-300 rounded-[10px] mt-[30px] px-6 py-4 ${
          ...
          >
            ...
            <p className="dm-sans-regular text-[1.4em]">{user?.firstName} {user?.lastName}</p>
            <p className="dm-sans-medium text-[2em] mt-4">Art of account</p>
            <p className="dm-sans-regular text-[1.4em]">Student</p>
            <p className="dm-sans-medium text-[2em] mt-4">Email address</p>
            <p className="dm-sans-regular text-[1.4em]">{user?.email}</p>
