            ...
            {userStudySets && userShortData && (
                <div>
                    <div className='flex justify-center items-center gap-[10px] mb-[42px]'>
                        <img className='w-[60px] h-[60px] rounded-[50%]' src={userShortData?.photo} alt="" />
                        <h2 className='text-[4em]'>{userShortData?.nickName}</h2>
                    </div>
                    <h3 className='text-center mb-[32px] dm-sans-medium text-[1.4em] text-leadong-[150%]'>ALL STUDY SETS</h3>
                    <div className='flex flex-col w-full items-center justify-center mb-[48px] mx-auto'>
                        <div className='w-[80%] h-[1px] bg-[#E1E1E1]'/>
                                    ...
                                    <li key={studySet?._id} onClick={() => onClickHandler(studySet.topic._id, studySet.studySet._id)} className='border-b-[1px] w-full hover:bg-[#69CA61] cursor-pointer border-[#E1E1E1] py-[14px]'>
                                        {studySet?.studySet && ( 
                                            <div className='flex w-full justify-between items-center'>
                                                <p className='dm-sans-medium text-[1.7em] text-leading-[150%]'>{studySet?.studySet?.title}</p>
